...
<div class="main">
    ...
    <script>
        ...
        function presentedLectures() {
            ...
            try{
                console.log("presentedLectures() Function called because user pressed the presented lectures button ");
        ...
        function displayPresentedLectures(lectures) {
            ...
            for(i=0;i<lectures.length;i++){
                ...
                out+='<tr>';
                out+='<td class="m"><input type="submit" '+'value="'+lecture_name+'" name="lecture"/></td>';
                out+='</tr>';
            }
            out+="</table>";
        ...
        function selectYourLecture() {
            ...
            try{
                xmlHttpRequest.open("POST",url,true);
                console.log("selectYourLecture() Function is called because user pressed the select your lecture .. ");
    ...
    <div id="fors">
        ...
        <div class="m" >
            <form method="post" action="choosedLectureServlet" id="presented_lectures">
